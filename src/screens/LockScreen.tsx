...
const s: Record<string, React.CSSProperties> = {
  container: {
    ...
    overflow: 'hidden',
    background: `
      radial-gradient(ellipse at 28% 22%, rgba(196,181,253,0.45) 0%, transparent 55%),
      radial-gradient(ellipse at 75% 75%, rgba(139,92,246,0.25) 0%, transparent 50%),
      linear-gradient(170deg, #7C3AED 0%, #5B21B6 50%, #3B0764 100%)
    `,
    display: 'flex',
  ...
  ray2: {
    ...
    width: '80px',
    height: '140%',
    background: 'linear-gradient(180deg, rgba(196,181,253,0.10) 0%, transparent 100%)',
  ...
  appName: {
    ...
    textShadow: '0 2px 20px rgba(196,181,253,0.6), 0 1px 4px rgba(0,0,0,0.3)',
    marginBottom: '10px',
  },
  tagline: {
    fontSize: '13px',
  ...
  lockWrap: {
    ...
    height: '80px',
    borderRadius: '50%',
    backgroundColor: 'rgba(245,243,255,0.15)',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    backdropFilter: 'blur(6px)',
  },
  lockIcon: { fontSize: '36px', filter: 'drop-shadow(0 0 10px rgba(196,181,253,0.8))' },
  ...
  dot: {
    ...
    height: '16px',
    borderRadius: '50%',
    border: '2px solid rgba(237,233,254,0.5)',
  ...
  dotFilled: {
    ...
    boxShadow: `0 0 10px rgba(196,181,253,0.9), 0 0 20px rgba(196,181,253,0.4)`,
  },
  dotErr: {
